...
This remains a locally managed identity system, not a managed identity provider. Production must configure a password-reset delivery webhook, strong independent secrets, trusted-proxy handling, and audit retention/export.
...
- define auth-audit retention and export policies;
